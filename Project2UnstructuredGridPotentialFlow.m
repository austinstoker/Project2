...
for j=GamStart:GamEnd
    ...
    dvdyA_fun = @(x,y) -U*(-1.000000000*y/(x^2+y^2)^1.500000000*x-3.000000000*y*a^2/(x^2+y^2)^2.500000000*x)*y/(x^2+y^2)^.500000000000000000-U*(x/(x^2+y^2)^.500000000000000000+x*a^2/(x^2+y^2)^1.50000000000000000)/(x^2+y^2)^.500000000000000000+1.000000000*U*(x/(x^2+y^2)^.500000000000000000+x*a^2/(x^2+y^2)^1.50000000000000000)*y^2/(x^2+y^2)^1.500000000+x*U*(1.000000000/(x^2+y^2)^.5000000000*y+1.000000000*a^2/(x^2+y^2)^1.500000000*y)*y/(x^2+y^2)^1.50000000000000000+x*U*((x^2+y^2)^.500000000000000000-a^2/(x^2+y^2)^.500000000000000000)/(x^2+y^2)^1.50000000000000000-3.000000000*U*((x^2+y^2)^.500000000000000000-a^2/(x^2+y^2)^.500000000000000000)*y^2/(x^2+y^2)^2.500000000*x+.3183098862/(x^2+y^2)^2*y*Gam*x;
